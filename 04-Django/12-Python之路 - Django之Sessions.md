...
- [Python之路 - Django之Cookie与Sessions](#python之路---django之cookie与sessions)
    - [介绍  🍀](#介绍--🍀)
    - [启用Sessions  🍀](#启用sessions--🍀)
    - [配置Session引擎  🍀](#配置session引擎--🍀)
        - [数据库  🍀](#数据库--🍀)
        - [缓存  🍀](#缓存--🍀)
        - [文件  🍀](#文件--🍀)
        - [Cookie  🍀](#cookie--🍀)
    - [视图中使用Session  🍀](#视图中使用session--🍀)
        - [序列化  🍀](#序列化--🍀)
        - [捆绑序列化器  🍀](#捆绑序列化器--🍀)
        - [自定义序列化器  🍀](#自定义序列化器--🍀)
        - [会话对象  🍀](#会话对象--🍀)
    - [设置Cookie测试  🍀](#设置cookie测试--🍀)
    - [视图外使用Sessions  🍀](#视图外使用sessions--🍀)
    - [会话保存  🍀](#会话保存--🍀)
    - [会话时长  🍀](#会话时长--🍀)
    - [清除会话存储  🍀](#清除会话存储--🍀)
