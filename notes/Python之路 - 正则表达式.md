...
> `re.search`(*pattern*, *string*, *flags=0*) :  :point_left:
...
> `re.findall`(*pattern*, *string*, *flags=0*) :  :point_left:
...
> `re.split`(*pattern*, *string*, *maxsplit=0*, *flags=0*) :  :point_left:
...
> `re.sub`(*pattern*, *repl*, *string*, *count=0*, *flags=0*) : :point_left:
